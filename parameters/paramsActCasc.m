...
p.delta1 = 12;          %mRNA dilution/degradation
p.delta2 = .5;          %protein dilution
p.RNAP = 2000;          %total RNAP
p.Ribo = 6800;          %total ribosomes
p.Ptot = 200;           %total protease
p.DNA = [50,200];       %total DNA (n)
p.K0 = [100,1000];      %TF/DNA binding cnst (m)
p.K1 = [200,200];       %RNAP/(TF/DNA) binding cnst (m)
p.Kp = [1e9,1e9];       %RNAP/DNA leaky binding cnst (n)
p.K2 = [50000,50000];   %mRNA/ribosome binding cnst (n)
