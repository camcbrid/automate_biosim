...
p.K0 = [100,1000];      %TF/DNA binding cnst
p.K1 = [200,200];       %RNAP/(TF/DNA) binding cnst
p.Kp = [1e9,1e9];       %RNAP/DNA leaky binding cnst
p.K2 = [50000,50000];   %mRNA/ribosome binding cnst
p.K3 = [1200,1200];     %protein/protease binding cnst
p.s = [1,1];            %coopertivity
